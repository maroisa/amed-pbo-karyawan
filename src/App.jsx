...
import {CEO, Bendahara, KepalaDivisi} from "./utils/karyawan.js"
...
export default function App(){
    ...
    onMount(() => {
        ...
        let krywn3 = new KepalaDivisi("K03", "Clara", 4, "P", "Pemberdayaan")
    ...
    return <div class="w-full max-w-5xl m-auto p-2">
        <div class="my-4 flex flex-row justify-between items-center">
            <h1 class="text-2xl font-bold">Data Karyawan</h1>
            <button onClick={() => setTambahActive(true)} class="border border-black/50 p-2 rounded-md shadow-lg active:border-black active:bg-black/10">
                Tambah
            </button>
        </div>
        <MainGrid karyawan={karyawan} setDetails={setDetails} hapusKaryawan={hapusKaryawan} />
        <Details details={details} setDetails={setDetails} />
        <Tambah tambahActive={tambahActive} setTambahActive={setTambahActive} addKaryawan={addKaryawan} />
    </div>
}